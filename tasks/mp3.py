...
def get_transcription(filename):
    audio_file = open(f"./tasks/nagrania/{filename}", "rb")
...
def get_answer(question, information):
...
audio_files = os.listdir("./tasks/nagrania")
for file in audio_files:
    print(file)
    tr = get_transcription(file)
    transcriptions.append(tr)
    print("trascription done")
